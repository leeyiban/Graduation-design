...
//			level: "level",			//层级
    ...
    DTree.prototype.selectSetting = function(options) {
        ...
        this.selectHousedDiv = this.obj[0].id + "_select_housed_div";	// 上级layui卡片节点
    ...
    DTree.prototype.renderSelectDom = function() {
        ...
        _this.obj.wrap('<div class="layui-housed dtree-select" dtree-id="' + rootId + '" dtree-housed="' + _this.selectHousedDiv + '"></div>').wrap('<div class="layui-housed-body"></div>').wrap('<div id="' + _this.selectTreeDiv + '"></div>');
    }
    ...
    DTree.prototype.bindBrowserEvent = function(){
        ...
        _this.obj.on("click", "div[dtree-click='"+eventName.itemNodeClick+"'][dtree-disabled='false']", function(event) {
            ...
            if(_this.select) {
                ...
                $("div[dtree-id='" + rootId + "'][dtree-housed='"+_this.selectHousedDiv+"']").toggleClass("dtree-select-show layui-anim layui-anim-upbit");
            }
    ...
    $BODY.on("click", function(event){
        ...
        $("div[dtree-id][dtree-housed]").removeClass("dtree-select-show layui-anim layui-anim-upbit");
    });
