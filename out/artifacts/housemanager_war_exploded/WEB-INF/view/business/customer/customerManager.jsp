	...
	<input type="text" name="address"  autocomplete="off" class="layui-input">
		 ...
		 <div class="layui-form-item">
		    ...
		    <div class="layui-inline">
		      ...
		      <div class="layui-input-inline">
		        <input type="text" name="houseeer"  autocomplete="off" class="layui-input">
		      </div>
		    </div>
		     <div class="layui-inline">
		...
		<form class="layui-form"  lay-filter="dataFrm" id="dataFrm">
			...
			<div class="layui-form-item">
				<div class="layui-inline">
					<label class="layui-form-label">客户职位:</label>
					<div class="layui-input-inline">
						<input type="text" name="houseeer"   placeholder="请输入客户职位" autocomplete="off"
							class="layui-input">
					</div>
				</div>
				<div class="layui-inline">
			 ...
			 tableIns=table.render({
			    ...
			    ,cols: [[   //列表数据
			     {type: 'checkbox', fixed: 'left'}
			      ...
			      ,{field:'houseeer', title:'客户职位',align:'center',width:'120'}
