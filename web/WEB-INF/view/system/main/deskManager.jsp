...
<div class="layui-row layui-col-space10">
	<div class="layui-col-lg6 layui-col-md6">
		<blockquote class="layui-elem-quote title">最新通告 <i class="layui-icon layui-red">&#xe756;</i></blockquote>
...
<script type="text/javascript">
	...
	function getLangDate(){
		...
		document.getElementById("nowTime").innerHTML = "亲爱的${user.realname}，"+timeValue+"好！ 欢迎使用房屋出租系统。当前时间为： "+newDate+"　"+week;
