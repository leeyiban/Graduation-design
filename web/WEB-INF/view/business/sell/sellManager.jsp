...
<body class="childrenBody">
		...
		<div class="layui-form-item">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="housenumber"   autocomplete="off"
							class="layui-input">
					</div>
				</div>
			</div>
	...
	<script type="text/html"  id="rentBar">
		 {{#  if(d.rentflag ==1){ }}
	  		<a class="layui-btn layui-btn-warm layui-btn-xs" lay-event="exportSell">导出出售单</a>
 		 {{#  } else { }}
   		 	<%--<a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
	  		<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">删除</a>--%>
	  		<a class="layui-btn layui-btn-warm layui-btn-xs" lay-event="exportRent">导出出售单</a>
  		 {{#  } }}		
		...
		<form class="layui-form"  lay-filter="dataFrm" id="dataFrm">
			...
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="text" name="sellprice" lay-verify="required"   placeholder="请输入出租价格" autocomplete="off"
							class="layui-input">
					</div>
				</div>
			</div>
	    ...
	    layui.use([ 'jquery', 'layer', 'form', 'table','laydate'  ], function() {
			...
			//渲染数据表格
			 tableIns=table.render({
			    ...
			    ,url:'${ctx}/sell/loadAllSell.action' //数据接口
			    ...
			    ,cols: [[   //列表数据
			      ...
			      ,{field:'housenumber', title:'房屋编号',align:'center',width:'150'}
			      ,{field:'sellflag', title:'出售状态',align:'center',width:'120',templet:function(d){
			    	  return d.sellflag=='1'?'<font color=red>未售</font>':'<font color=blue>已售</font>';
			      }}
			      ,{field:'begindate', title:'起售时间',align:'center',width:'180'}
			      ,{field:'price', title:'出售价格',align:'center',width:'120'}
			...
			$("#doSearch").click(function(){
				...
				tableIns.reload({
					url:"${ctx}/sell/loadAllSell.action?"+params ,
				    page:{
				    	curr:1
				    }
				})
		   ...
		   table.on('tool(rentTable)', function(obj){
			  ...
			  if(layEvent === 'del'){ //删除
				  layer.confirm('真的删除【'+data.priceid+'】这个出租单吗', function(index){
				  	// ↑卖出
				       //向服务端发送删除指令
				       $.post("${ctx}/sell/deleteSell.action",{rentid:data.rentid},function(res){
				    	   layer.msg(res.msg);
				    	    //刷新数据 表格
						tableIns.reload();
				       })
			     ...
			     openUpdateSell(data);
				   ...
				   window.location.href="${ctx}/stat/exportSell.action?rentid="+data.rentid;
			   }
			 });
			...
			/*function openUpdateSell(data){
				mainIndex=layer.open({
					...
					success:function(index){
						...
						url="${ctx}/sell/updateSell.action";
					}
				});
			}
			//保存
