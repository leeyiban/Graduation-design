...
public interface SysConstast {
	 ...
	 * 默认图片地址
	 */
	Object DEFAULT_HOUSE_IMG = "images/defaulthouseimage.jpg";

	/**
	 * 单号的前缀
	 */
	String HOUSE_ORDER_CZ = "CZ";
	String HOUSE_ORDER_JC = "JC";
	 ...
	 * 出租状态
	 */
	Integer RENT_HOUSE_TRUE = 1;
	Integer RENT_HOUSE_FALSE = 0;

	/**
	 * 买卖状态
	 */
	Integer SELL_HOUSE_TRUE = 1;
	Integer SELL_HOUSE_FALSE = 0;
