...
public class  InitMenuData {
	...
	public static void main(String[] args) {
		...
		menuMapper.insert(new Menu(1, 0, "房屋出租系统", null, 1, null, "&#xe68e;", 1));
		...
		menuMapper.insert(new Menu(7, 2, "房屋管理", null, 0, null, "&#xe657;", 1));
		
		
		menuMapper.insert(new Menu(8, 3, "房屋出租", null, 0, null, "&#xe65b;", 1));
		menuMapper.insert(new Menu(9, 3, "出租单管理", null, 0, null, "&#xe6b2;", 1));
		menuMapper.insert(new Menu(10, 3, "房屋入库", null, 0, null, "&#xe65a;", 1));
